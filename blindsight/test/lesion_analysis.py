...
def plot(args):
	...
	plt.fill(np.append(x_range, [x_range[-1], x_range[0]]),np.append(control_conf_correct_dist, [0, control_conf_correct_dist[0]]),color='lightgreen',alpha=0.5,edgecolor=None)
	plt.fill(np.append(x_range, [x_range[-1], x_range[0]]),np.append(control_conf_incorrect_dist, [0, control_conf_incorrect_dist[0]]),color='slateblue',alpha=0.5,edgecolor=None)
	...
	plt.fill(np.append(x_range, [x_range[-1], x_range[0]]),np.append(lesion_conf_correct_dist, [0, lesion_conf_correct_dist[0]]),color='lightgreen',alpha=0.5,edgecolor=None)
	plt.fill(np.append(x_range, [x_range[-1], x_range[0]]),np.append(lesion_conf_incorrect_dist, [0, lesion_conf_incorrect_dist[0]]),color='slateblue',alpha=0.5,edgecolor=None)
	plt.xlabel('Confidence', fontsize=axis_fontsize)
	plt.ylabel('Density estimate', fontsize=axis_fontsize)
	plt.xlim([min_x,max_x])
	plt.xticks([.5,.6,.7,.8,.9,1],['0.5','0.6','0.7','0.8','0.9','1'], fontsize=tick_fontsize)
