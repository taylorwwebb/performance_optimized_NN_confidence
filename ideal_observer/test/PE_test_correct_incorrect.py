...
def plot(args):
	...
	for r in range(args.N_runs):
		...
		all_test_conf_correct = test_results['all_test_conf_correct']
		all_test_conf_incorrect = test_results['all_test_conf_incorrect']
	...
	# Save plot
	plt.tight_layout()
	plot_fname = model_dir + 'ideal_observer_PE_bias_correct_incorrect.png'
