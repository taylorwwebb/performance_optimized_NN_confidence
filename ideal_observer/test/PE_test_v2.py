...
def plot(args):
	...
	for r in range(args.N_runs):
		...
		low_PE_test_conf = test_results['low_PE_test_conf']
		high_PE_test_acc = test_results['high_PE_test_acc']
		high_PE_test_conf = test_results['high_PE_test_conf']
	...
	# Write to file
	params_fname = model_dir + 'PE_bias_v2_stim_params.txt'
	...
	# Stats
	# Open file
	stats_fname = model_dir + 'PE_bias_v2_stats.txt'
	...
	# Save plot
	plot_fname = model_dir + 'ideal_observer_PE_bias_v2.png'
