...
def plot(args):
	...
	# Stats
	# Open file
	stats_fname = './PE_stats_' + args.train_regime + '.txt'
	...
	plt.yticks([0.35,0.45,0.55,0.65,0.75],['0.35','0.45','0.55','0.65','0.75'], fontsize=tick_font_size)
	...
	# Save plot
	plot_fname = './PE_bias_' + args.train_regime + '.png'
