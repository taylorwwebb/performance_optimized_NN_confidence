...
def plot(args):
	...
	plt.ylim([0.6,1])
	plt.yticks([0.6,0.7,0.8,0.9,1],['0.6','0.7','0.8','0.9','1'], fontsize=tick_font_size)
	...
	ax.text(0.5,y_end-0.035,conf_correct_p_symb,fontsize=significance_font_size,horizontalalignment='center')
	...
	ax.text(3,y_end-0.035,conf_incorrect_p_symb,fontsize=significance_font_size,horizontalalignment='center')
	# Title
	plt.title('PE bias (v2) - MNIST',fontsize=title_font_size)
	# Save plot
	plt.tight_layout()
	plot_fname = './PE_bias_v2_MNIST_correct_incorrect.png'
