...
ax = plt.subplot(2,1,1)
plt.fill(np.append(x_range, x_range[0]),np.append(abs_x_correct_dist, abs_x_correct_dist[0]),color='turquoise',alpha=0.5,edgecolor=None)
plt.fill(np.append(x_range, x_range[0]),np.append(abs_x_incorrect_dist, abs_x_incorrect_dist[0]),color='salmon',alpha=0.5,edgecolor=None)
plt.xlabel('|Decision variable|',fontsize=axis_fontsize)
plt.ylabel('Density estimate',fontsize=axis_fontsize)
plt.title('Control', fontsize=title_fontsize)
plt.xlim([x_min, x_max])
...
ax = plt.subplot(2,1,2)
plt.fill(np.append(x_range, x_range[0]),np.append(abs_x_TMS_correct_dist, abs_x_TMS_correct_dist[0]),color='turquoise',alpha=0.5,edgecolor=None)
plt.fill(np.append(x_range, x_range[0]),np.append(abs_x_TMS_incorrect_dist, abs_x_TMS_incorrect_dist[0]),color='salmon',alpha=0.5,edgecolor=None)
plt.xlabel('|Decision variable|',fontsize=axis_fontsize)
plt.ylabel('Density estimate',fontsize=axis_fontsize)
plt.title('TMS (' + r'$\xi$'  + '=' + str(TMS_noise_var) + ')', fontsize=title_fontsize)
plt.xlim([x_min, x_max])
