...
def plot(args):
	...
	plt.title('Effect of simulated lesion to penultimate layer', fontsize=title_fontsize)
	plot_fname = './lesion_' + str(args.lesion) + '/penultimate_lesion_d_vs_meta_d.png'
